/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false` (hash: 78081ed9ffc4d4152d371895c0d5eb8e)
...
interface __BaseEnv_Env {
	...
	PROTON_SMTP_HOST: string;
	PROTON_SMTP_PORT: string;
	TURNSTILE_SECRET_KEY: string;
	PROTON_SMTP_USERNAME: string;
	PROTON_SMTP_PASSWORD: string;
	MAIL_FROM: string;
	MAIL_TO: string;
	MAIL_PROBE_TOKEN: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ASSISTANT_PROVIDER" | "MAIL_TRANSPORT_MODE" | "PROTON_SMTP_HOST" | "PROTON_SMTP_PORT" | "TURNSTILE_SECRET_KEY" | "PROTON_SMTP_USERNAME" | "PROTON_SMTP_PASSWORD" | "MAIL_FROM" | "MAIL_TO" | "MAIL_PROBE_TOKEN">> {}
}
