...
hero:
  ...
  primaryCta:
    ...
    href: /contact/
  secondaryCta:
    label: Call +1.833.43.STEEL
    href: tel:+18334378335
  trustStrip:
    - text: Gretna, Louisiana
    - text: Federal immigration matters across the United States
    - text: Louisiana matters for traffic ticket and notary services
...
immigrationHighlight:
  ...
  links:
    - label: Worksite I-9 Audits and Defense
      ...
      summary: Start with the record, the deadline, and the right lane.
    - label: O Visas
      href: /immigration/o-visas-extraordinary-ability/
      summary: Start with the record, the deadline, and the right lane.
    - label: National Interest Waivers
      href: /immigration/national-interest-waiver/
      summary: Start with the record, the deadline, and the right lane.
    - label: S Visas and T Visas
      href: /immigration/asylum-humanitarian-relief/
      summary: Start with the record, the deadline, and the right lane.
    - label: Habeas and Federal Court Relief
...
languages:
  ...
  list:
    ...
    - text: Vietnamese
    - text: Russian and Ukrainian-facing routing
footerCta:
